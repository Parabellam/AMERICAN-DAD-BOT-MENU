...
def action_buttons(frame, isThereRewards):
    button1 = tk.Button(frame, text="Mañana Mimosa", command=lambda: function_join_mananamimosa(root, isThereRewards.get()), width=20, height=2, bg='lightgrey', fg='black', font=('Helvetica', 12, 'bold'), state='disabled')
...
buttons = action_buttons(frame, isThereRewards)
